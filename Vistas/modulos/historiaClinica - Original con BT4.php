		...
		<div class="container">
			<div class="row">
				<div class="col-md-1">
					...
					<h2>  <a style="font-size: 28px" href="http://localhost/clinica/hc-paciente"> 
			...
			<div style="font-size: 28px" class="col-md-9">
				HISTORIA CLÍNICA
			</div>
			...
			<div class="col-md-2">
				...
				echo'
				<div><a style="font-size: 28px" href="http://localhost/clinica/tratamientos/'.$id_paciente.'"> <button class="btn btn-primary">VER TRATAMIENTO DE PACIENTE</button> </a></div>
				';?>
			</div>
